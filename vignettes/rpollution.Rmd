...
```{r current-example-result, fig.width=7, fig.height=4, fig.cap = "Map of air pollution" }
pollution_map_plot
```
...
```{r forecast-example-result, fig.width=8, fig.height=4, fig.cap = "Air pollution forecast"}
forecast_plot
```
